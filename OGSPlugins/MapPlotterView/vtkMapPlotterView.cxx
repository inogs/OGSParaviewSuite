...
vtkStandardNewMacro(vtkMapPlotterView);

//----------------------------------------------------------------------------
vtkMapPlotterView::vtkMapPlotterView() {
	this->Script = NULL;
}
...
//----------------------------------------------------------------------------
void vtkMapPlotterView::SetParameterInternal(const char* raw_name, const char* raw_value) {
...
void vtkMapPlotterView::SetParameter(const char* raw_name, const char* value) {
	std::ostringstream buf;
...
void vtkMapPlotterView::SetParameter(const char* raw_name, int value)
{
  std::ostringstream buf;
  buf << value;
  this->SetParameterInternal(raw_name, buf.str().c_str());
...
void vtkMapPlotterView::SetParameter(const char* raw_name, double value)
{
  std::ostringstream buf;
  buf << value;
  this->SetParameterInternal(raw_name, buf.str().c_str());
...
void vtkMapPlotterView::SetParameter(
...
void vtkMapPlotterView::SetParameter(const char* raw_name, double value1, double value2)
{
  std::ostringstream buf;
  buf << "[" << value1 << ", " << value2 << "]";
  this->SetParameterInternal(raw_name, buf.str().c_str());
