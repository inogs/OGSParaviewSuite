...
vtkStandardNewMacro(vtkOGSMapPlot);

//----------------------------------------------------------------------------
vtkOGSMapPlot::vtkOGSMapPlot() {
	this->Script    = NULL;
	this->Variables = NULL;	
}
...
//----------------------------------------------------------------------------
void vtkOGSMapPlot::SetParameterInternal(const char* raw_name, const char* raw_value) {
...
void vtkOGSMapPlot::SetParameter(const char* raw_name, const char* value) {
	std::ostringstream buf;
...
void vtkOGSMapPlot::SetParameter(const char* raw_name, int value)
{
  std::ostringstream buf;
  buf << value;
  this->SetParameterInternal(raw_name, buf.str().c_str());
...
void vtkOGSMapPlot::SetParameter(const char* raw_name, double value)
{
  std::ostringstream buf;
  buf << value;
  this->SetParameterInternal(raw_name, buf.str().c_str());
...
void vtkOGSMapPlot::SetParameter(
...
void vtkOGSMapPlot::SetParameter(const char* raw_name, double value1, double value2)
{
  std::ostringstream buf;
  buf << "[" << value1 << ", " << value2 << "]";
  this->SetParameterInternal(raw_name, buf.str().c_str());
